<template>
    ...
    <main>
        <div class="flex">
            <!-- <div class="rounded-r-full mt-6 w-[10%] md:w-[35%] h-28 font-inter bg-teal-400 -z-50 md:mt-5 drop-shadow-lg">
            <p class="text-center py-10 text-2xl md:text-2xl text-white font-semibold">Data Node 1 <span class=""></span> </p>
        </div> -->
...
export default{
    ...
    methods: {
        getId() {
            axios
            .get('http://localhost:40027/alat-1-ppm')
            .then(response => {
        ...
        getItems() {
        axios
        .get('http://localhost:3000/alat-1-ppm')
        .then(response => {
            console.log("awal")
